...
const GANTT_DATA = [
  ...
  { id: 'vaultwarden', num:'04', label: 'Vaultwarden',                  start:[2024,11], end:[2024,12], color:'#ec4899' },
  { id: 'apache',      num:'05', label: 'Serveur Web Apache',           start:[2025,2],  end:[2025,3],  color:'#06b6d4' },
  { id: 'adguard',     num:'06', label: 'AdGuard Home',                 start:[2025,2],  end:[2025,3],  color:'#10b981' },
  { id: 'tailscale',   num:'07', label: 'Tailscale VPN Zero Trust',     start:[2025,4],  end:[2025,5],  color:'#6366f1' },
  { id: 'pfsense',     num:'08', label: 'Pare-feu pfSense',             start:[2025,5],  end:[2025,6],  color:'#f59e0b' },
